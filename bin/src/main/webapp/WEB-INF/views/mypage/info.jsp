            ...
            <div class="login-wrapper">
                ...
                <form>
                    ...
                    <div class="field">
                        ...
                        <input type="text" id="nickname" name="nickname" value="닉네임" readonly>
                    </div>
                    ...
                    <div class="field full">
                        ...
                        <input type="email" id="useremail" name="useremail" value="user@example.com" readonly>
                    </div>
                    ...
                    <div class="field">
                        ...
                        <div class="input-lock input-toggle">
                            <input type="password" id="pw1" name="pw1" value="1234" readonly>
                    ...
                    <div class="btn-col">
                        ...
                        <button class="joinok-btn" type="button" onclick="location.href='./update.html'">
                            정보 변경
                        </button>
                    </div>
