...
public class LocaleService {
  ...
  public Long createReservation(
    ...
    if (bandName == null || bandName.isBlank()) throw new IllegalArgumentException("밴드명은 필수");
    if (bandCount < 1) throw new IllegalArgumentException("인원은 1 이상");
    if (reservationDate == null || reservationDate.isBlank()) throw new IllegalArgumentException("날짜 필수");
    if (startTime == null || startTime.isBlank()) throw new IllegalArgumentException("시간 필수");
